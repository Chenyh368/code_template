...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--json_path', type=str, default='./config/base.json')
        # ============== Dataset =====================
        parser.add_argument('--dataset', type=str, default='cifar10',
                            help='chooses which datasets are loaded. [cifar10 |]')
        parser.add_argument('--dataset_dir', type=str, default='')
        # ============== Model =====================
        parser.add_argument('--model', type=str, default='gaussian_diffusion',
                            help='chooses which model to use. [gaussian_diffusion |]')
        # ============== Additional =====================
